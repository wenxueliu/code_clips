...
#auth_version 1(default): you can login only by (auth_url user key)
#             2: 1) 'object_storage_url' and 'auth_token' in 'os_option' 
#                2)
#                  1/'tenant_name' in kwargs 
#                  2/'tenant_name' not in kwargs and 'usr' is tenant_name:user
#                  call get_keystoneclient_2_0()
#                  3/'tenant_name' not in kwargs and 'usr' is not tenant_name:user
#                  raise
#return : storager_url t
...
class Connection(object):
    ...
    #wraps all the member of Connection as  func(*args, *kwargs)
