...
public class DatabaseManager {
    ...
    private static EmbeddedConnectionPoolDataSource40 ds;
    ...
    private static ConnectionPoolDataSource initDataSource(String dbname, String user, 
            String password) {
    ...
    public static void initDatabase(String dbname, String user, String password,
            boolean dropTables) 
        throws Exception {
        dataSource = initDataSource(dbname, user, password);
